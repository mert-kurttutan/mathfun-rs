...
impl_unary!(
    ...
    "x86_64" | RUNTIME_HW_CONFIG.sse2 && RUNTIME_HW_CONFIG.sse => vd_sqrt_sse2,
    "x86" | RUNTIME_HW_CONFIG.sse => vd_sqrt_sse2,
...
impl_unary!(
    ...
    "x86_64" | RUNTIME_HW_CONFIG.sse2 && RUNTIME_HW_CONFIG.sse => vs_sqrt_sse2,
    "x86" | RUNTIME_HW_CONFIG.sse => vs_sqrt_sse2,
...
mod avx2_fma_mod {
    ...
    pub(crate) unsafe fn vs_exp_avx2_fma(n: usize, a: *const f32, b: *mut f32) {
        Avx2Fma::vs_exp(n, a, b);
    }

    pub(crate) unsafe fn vs_ln_avx2_fma(n: usize, a: *const f32, b: *mut f32) {
        Avx2Fma::vs_ln(n, a, b);
    }

    pub(crate) unsafe fn vs_tanh_avx2_fma(n: usize, a: *const f32, b: *mut f32) {
        Avx2Fma::vs_tanh(n, a, b);
    }

    pub(crate) unsafe fn vs_sin_avx2_fma(n: usize, a: *const f32, b: *mut f32) {
        Avx2Fma::vs_sin(n, a, b);
    }

    pub(crate) unsafe fn vs_cos_avx2_fma(n: usize, a: *const f32, b: *mut f32) {
        Avx2Fma::vs_cos(n, a, b);
    }
}
#[cfg(target_arch = "x86_64")]
...
mod avx_sse2_mod {
    ...
    pub(crate) unsafe fn vs_exp_avx_sse2(n: usize, a: *const f32, b: *mut f32) {
        AvxSse2::vs_exp(n, a, b);
    }

    pub(crate) unsafe fn vs_ln_avx_sse2(n: usize, a: *const f32, b: *mut f32) {
        AvxSse2::vs_ln(n, a, b);
    }

    pub(crate) unsafe fn vs_sin_avx_sse2(n: usize, a: *const f32, b: *mut f32) {
        AvxSse2::vs_sin(n, a, b);
    }

    pub(crate) unsafe fn vs_cos_avx_sse2(n: usize, a: *const f32, b: *mut f32) {
        AvxSse2::vs_cos(n, a, b);
    }

    pub(crate) unsafe fn vs_tanh_avx_sse2(n: usize, a: *const f32, b: *mut f32) {
        AvxSse2::vs_tanh(n, a, b);
    }

    pub(crate) unsafe fn vs_sqrt_avx(n: usize, a: *const f32, b: *mut f32) {
        AvxSse2::vs_sqrt(n, a, b);
    }

    pub(crate) unsafe fn vd_sqrt_avx(n: usize, a: *const f64, b: *mut f64) {
        AvxSse2::vd_sqrt(n, a, b);
    }
}
#[cfg(target_arch = "x86_64")]
...
mod sse2_mod {
    ...
    pub(crate) unsafe fn vs_exp_sse2(n: usize, a: *const f32, b: *mut f32) {
        Sse2::vs_exp(n, a, b);
    }

    pub(crate) unsafe fn vs_ln_sse2(n: usize, a: *const f32, b: *mut f32) {
        Sse2::vs_ln(n, a, b);
    }

    pub(crate) unsafe fn vs_sin_sse2(n: usize, a: *const f32, b: *mut f32) {
        Sse2::vs_sin(n, a, b);
    }

    pub(crate) unsafe fn vs_cos_sse2(n: usize, a: *const f32, b: *mut f32) {
        Sse2::vs_cos(n, a, b);
    }

    pub(crate) unsafe fn vs_tanh_sse2(n: usize, a: *const f32, b: *mut f32) {
        Sse2::vs_tanh(n, a, b);
    }

    pub(crate) unsafe fn vs_sqrt_sse2(n: usize, a: *const f32, b: *mut f32) {
        Sse2::vs_sqrt(n, a, b);
    }

    pub(crate) unsafe fn vd_sqrt_sse2(n: usize, a: *const f64, b: *mut f64) {
        Sse2::vd_sqrt(n, a, b);
    }
}
#[cfg(any(target_arch = "x86", target_arch = "x86_64"))]
